...
| Uniswap CCA verified-listing plan | ../docs/25_UNISWAP_CCA_VERIFIED_LISTING_PLAN.md | Official criteria, PNET scorecard, and application path | Maintainer-controlled readiness record; no badge claimed |
| Base treasury and distribution plan | ../docs/26_BASE_TREASURY_AND_DISTRIBUTION_PLAN.md | Custody controls, beneficial-owner distribution, and future-round decision gates | Maintainer-controlled plan; second standard CCA is currently no-go |
...
| Uniswap PNET CCA | https://app.uniswap.org/explore/auctions/base/0x777900C0FF11845c8e0D6C134b58C695023Aab4e | Active Continuous Clearing Auction | Official Uniswap UI reference; no verified badge claimed |
| CCA launcher transaction | https://basescan.org/tx/0xcaca93427d8d2a3c29704373e2906ca8e8ce5c84fe5198ce48e9b5726951cb54 | Creates the PNET auction/strategy configuration | Public chain reference |
...
| Uniswap CCA Verified Listings | https://support.uniswap.org/hc/en-us/articles/43107250032781-What-are-CCA-Verified-Listings | Official pink-check eligibility criteria | Official Uniswap support reference |
| Uniswap CCA evaluation form | https://share.hsforms.com/1AN-LREhwT3uK03oGKvOGvgs8pgg | Official form linked from the criteria page | Do not submit until eligibility evidence is complete |
