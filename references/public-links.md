...
| Algonode Indexer API | https://mainnet-idx.algonode.cloud/v2/assets/3169177585 | Public read-only indexer endpoint | Needs verification |
| Nodely Indexer API | https://mainnet-idx.4160.nodely.dev/v2/assets/3169177585 | Public read-only indexer endpoint | Needs verification |
...
| Task | Status |
| --- | --- |
| Add a direct Algorand explorer or indexer source for ASA metadata | Needs verification |
| Confirm asset name, unit, decimals, and total supply from an on-chain source | Needs verification |
